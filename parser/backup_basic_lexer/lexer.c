...
//ENUM VALUES TO REPRESENT TOKENS...WHILE USING IN PARSER
enum
{
    ...
    TK_KWTRU,TK_KWFLS,TK_PLUS,TK_MINUS,TK_MUL,TK_DIV,TK_$,TK_KWREP,TK_KWFDEF,TK_KWUNT,TK_KWRET,TK_COM,TK_LSB,TK_RSB,TK_COL,TK_NOT,
    TK_GT,TK_LT,TK_LET,TK_NEQ,TK_EQEQ
}token;
...
switch(n)
    {
	case 1: fprintf(fout,"TK_KWIF        %d        \n",TK_KWIF);break;
	case 2: fprintf(fout,"TK_KWINT       %d        \n",TK_KWINT);break;
	case 3: fprintf(fout,"TK_KWREP       %d        \n",TK_KWREP);break;
	case 4: fprintf(fout,"TK_KWSTR       %d        \n",TK_KWSTR);break;
	case 5: fprintf(fout,"TK_KWFDEF      %d        \n",TK_KWFDEF);break;
	case 6: fprintf(fout,"TK_KWFLS       %d        \n",TK_KWFLS);break;
	case 7: fprintf(fout,"TK_KWBOL       %d        \n",TK_KWBOL);break;
	case 8: fprintf(fout,"TK_KWTRU       %d        \n",TK_KWTRU);break;
	case 9: fprintf(fout,"TK_KWELS       %d        \n",TK_KWELS);break;
	case 10: fprintf(fout,"TK_KWLFT      %d        \n",TK_KWLFT);break;
	case 11: fprintf(fout,"TK_KWWHL      %d        \n",TK_KWWHL);break;
	case 12: fprintf(fout,"TK_KWUNT      %d        \n",TK_KWUNT);break;
	case 13: fprintf(fout,"TK_KWRET      %d        \n",TK_KWRET);break;
    }
	flag3 = 1;
}
...
int get_state(char* ch,int state)
{
       ...
       switch(state)
       {
		...
		switch(*ch)
		{
			...
			case '&': {print_token(23);next_state = 0;start = current;break;}
	...
	case 45:
	{
		...
		{
		      retract();
		      print_keyword(6); //prints 'else' keyword
			next_state = 0;
			break;
		}
		else
